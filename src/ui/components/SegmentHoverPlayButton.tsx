...
export class SegmentHoverPlayButton extends Component<SegmentPlayButtonProps> {
  ...
  private _firstCharsRange = computed(() => {
    ...
    firstCharsRange.setEnd(
      firstCharsRange.startContainer,
      Math.min(
  ...
  private _attachClickHandler() {
    ...
    const container =
      firstCharsRange.commonAncestorContainer instanceof Text
  ...
  public render() {
    ...
    return (
      ...
      >
        {/* Animated underline */}
        <div
          class="underline-expand absolute bottom-0 left-0 h-1 bg-sky-500 opacity-0 group-hover:opacity-100 group-hover-active:opacity-100"
          style={{
